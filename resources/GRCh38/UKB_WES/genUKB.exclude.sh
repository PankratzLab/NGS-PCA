...
cat xgen_plus_spikein.b38.bed.gz |zcat |awk '{print "chr"$1"\t"$2-20000"\t"$3+20000}' |bgzip >xgen_plus_spikein.b38.chr.bed.gz
...
awk '{if($2-20000 <0 0) print "chr"$1"\t"0"\t"$3+20000; else print "chr"$1"\t"$2-20000"\t"$3+20000}'